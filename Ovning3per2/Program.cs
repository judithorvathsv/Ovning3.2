   ...
   public class Program
    {
        public static void Main(string[] args)
        {
            ...
            PrintAnimalWithAnimalSats(animals);
        ...
        public static void PrintAnimalWithSound(List<Animal> animals)
        {
        ...
        public static void CheckPersonAndTalk(List<Animal> animals)
        {
        ...
        //Printing Animal Stats() method
        public static void PrintAnimalWithAnimalSats(List<Animal> animals)
        {
        ...
        public static void PrintAnimalWithOwnSats(List<Animal> animals)
        {
        ...
        public static void PrintDogslWithAnimalSats(List<Animal> animals)
        {
        ...
        public static void JumpingDog(List<Animal> animals)
        {
            Console.WriteLine("Jump() for Dogs");
            foreach (var item in animals)
            {
